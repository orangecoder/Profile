    ...
    public static class LayoutParams extends ViewGroup.LayoutParams {
        ...
        public LayoutParams(Context c, AttributeSet attrs) {
            ...
            for (int i = 0; i < N; i++) {
                ...
                if(attr == R.styleable.ImageLayout_Layout_layout_top)
                {
                	top = a.getInt(attr, -1);
                	continue;
                }
                if(attr == R.styleable.ImageLayout_Layout_layout_right)
                {
                	right = a.getInt(attr, -1);
                	continue;
                }
                if(attr == R.styleable.ImageLayout_Layout_layout_bottom)
                {
                	bottom = a.getInt(attr, -1);
                	continue;
                }
                if(attr == R.styleable.ImageLayout_Layout_layout_centerX)
                {
                	centerX = a.getInt(attr, -1);
                	continue;
                }
                if(attr == R.styleable.ImageLayout_Layout_layout_centerY)
                {
                	centerY = a.getInt(attr, -1);
                	continue;
                }
                if(attr == R.styleable.ImageLayout_Layout_layout_maxWidth)
                {
                	maxWidth = a.getInt(attr, -1);
                	continue;
                }
                if(attr == R.styleable.ImageLayout_Layout_layout_height)
                {
                	height = a.getInt(attr, -1);
                	continue;
                }
                if(attr == R.styleable.ImageLayout_Layout_layout_maxHeight)
                {
